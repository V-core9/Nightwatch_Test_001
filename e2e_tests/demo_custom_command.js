describe('modify device dimensions', function () {
    ...
    const clickOptionsDemo = {
        ...
        timeout: {
            before: 2000,           // pre-click timeout
            after: 5000,            // post-click timeout
        },
    ...
    it('modifies the device dimensions and then resets it', function () {
        ...
        browser
            ...
            .clickExtended('div[jscontroller="w4UyN"]', { waitUntilVisible: true, timeout: { before: 0, after: 1000, }, verbose })
